...
import TinvestPy.TinvestPy.grpc.common_pb2
import builtins
...
class InstrumentsRequest(google.protobuf.message.Message):
    ...
    instrument_status: TinvestPy.TinvestPy.grpc.common_pb2.InstrumentStatus.ValueType
    ...
    def __init__(
        self,
        *,
        instrument_status: TinvestPy.TinvestPy.grpc.common_pb2.InstrumentStatus.ValueType | None = ...,
...
class GetBondEventsResponse(google.protobuf.message.Message):
    ...
    class BondEvent(google.protobuf.message.Message):
        ...
        @property
        def event_total_vol(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        ...
        @property
        def pay_one_bond(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
            """Выплата на одну облигацию."""

        @property
        def money_flow_val(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
            """Выплаты на все бумаги, задействованные в событии."""

        @property
        def value(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        ...
        @property
        def coupon_interest_rate(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        ...
        def __init__(
            ...
            *,
            ...
            event_type: global___GetBondEventsRequest.EventType.ValueType = ...,
            event_total_vol: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
            ...
            pay_one_bond: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
            money_flow_val: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
            execution: builtins.str = ...,
            operation_type: builtins.str = ...,
            value: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
            note: builtins.str = ...,
            convert_to_fin_tool_id: builtins.str = ...,
            ...
            coupon_period: builtins.int = ...,
            coupon_interest_rate: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        ) -> None: ...
...
class Option(google.protobuf.message.Message):
    ...
    trading_status: TinvestPy.TinvestPy.grpc.common_pb2.SecurityTradingStatus.ValueType
    """Текущий режим торгов инструмента."""
    real_exchange: TinvestPy.TinvestPy.grpc.common_pb2.RealExchange.ValueType
    ...
    @property
    def brand(self) -> TinvestPy.TinvestPy.grpc.common_pb2.BrandData:
        """Информация о бренде."""

    @property
    def basic_asset_size(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        """Размер основного актива."""

    @property
    def klong(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
    ...
    @property
    def kshort(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
    ...
    @property
    def dlong(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
    ...
    @property
    def dshort(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
    ...
    @property
    def dlong_min(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
    ...
    @property
    def dshort_min(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
    ...
    @property
    def min_price_increment(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        """Минимальный шаг цены."""

    @property
    def strike_price(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
        """Цена страйка."""

    @property
    def dlong_client(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
    ...
    @property
    def dshort_client(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
    ...
    def __init__(
        ...
        *,
        ...
        country_of_risk_name: builtins.str = ...,
        sector: builtins.str = ...,
        brand: TinvestPy.TinvestPy.grpc.common_pb2.BrandData | None = ...,
        lot: builtins.int = ...,
        basic_asset_size: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        klong: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        kshort: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        dlong: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        dshort: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        dlong_min: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        dshort_min: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        min_price_increment: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        strike_price: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        dlong_client: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        dshort_client: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
...
class Bond(google.protobuf.message.Message):
    ...
    @property
    def nominal(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
        """Номинал облигации."""

    @property
    def initial_nominal(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
    ...
    @property
    def placement_price(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
        """Цена размещения."""

    @property
    def aci_value(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
    ...
    def __init__(
        ...
        *,
        ...
        nominal: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        initial_nominal: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        state_reg_date: google.protobuf.timestamp_pb2.Timestamp | None = ...,
        placement_date: google.protobuf.timestamp_pb2.Timestamp | None = ...,
        placement_price: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        aci_value: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        country_of_risk: builtins.str = ...,
        country_of_risk_name: builtins.str = ...,
        sector: builtins.str = ...,
        issue_kind: builtins.str = ...,
...
class Etf(google.protobuf.message.Message):
    ...
    @property
    def fixed_commission(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
    ...
    @property
    def num_shares(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
    ...
    def __init__(
        ...
        *,
        ...
        name: builtins.str = ...,
        exchange: builtins.str = ...,
        fixed_commission: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        focus_type: builtins.str = ...,
        released_date: google.protobuf.timestamp_pb2.Timestamp | None = ...,
        num_shares: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        country_of_risk: builtins.str = ...,
        country_of_risk_name: builtins.str = ...,
        sector: builtins.str = ...,
        rebalancing_freq: builtins.str = ...,
...
class Future(google.protobuf.message.Message):
    ...
    @property
    def initial_margin_on_buy(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
        """Гарантийное обеспечение при покупке."""

    @property
    def initial_margin_on_sell(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
        """Гарантийное обеспечение при продаже."""

    @property
    def min_price_increment_amount(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        """Стоимость шага цены."""
    ...
    def __init__(
        ...
        *,
        ...
        first_1min_candle_date: google.protobuf.timestamp_pb2.Timestamp | None = ...,
        first_1day_candle_date: google.protobuf.timestamp_pb2.Timestamp | None = ...,
        initial_margin_on_buy: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        initial_margin_on_sell: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        min_price_increment_amount: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        brand: TinvestPy.TinvestPy.grpc.common_pb2.BrandData | None = ...,
        dlong_client: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        dshort_client: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
    ) -> None: ...
...
class StructuredNote(google.protobuf.message.Message):
    ...
    class BasicAsset(google.protobuf.message.Message):
        ...
        """Тип базового актива."""
        @property
        def initial_price(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        ...
        def __init__(
            ...
            *,
            uid: builtins.str = ...,
            type: global___AssetType.ValueType = ...,
            initial_price: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        ) -> None: ...
    ...
    @property
    def safety_barrier(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
    ...
    def __init__(
        ...
        *,
        ...
        safety_barrier: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        coupon_period_base: builtins.str = ...,
        observation_principle: global___StructuredNote.ObservationPrinciple.ValueType = ...,
        observation_frequency: builtins.str = ...,
...
class AccruedInterest(google.protobuf.message.Message):
    ...
    @property
    def value_percent(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        """Величина выплаты в процентах от номинала."""

    @property
    def nominal(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        """Номинал облигации."""
    ...
    def __init__(
        ...
        *,
        date: google.protobuf.timestamp_pb2.Timestamp | None = ...,
        value: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        value_percent: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        nominal: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
    ) -> None: ...
...
class Instrument(google.protobuf.message.Message):
    ...
    blocked_tca_flag: builtins.bool
    """Флаг заблокированного ТКС."""
    instrument_kind: TinvestPy.TinvestPy.grpc.common_pb2.InstrumentType.ValueType
    """Тип инструмента."""
    @property
    def klong(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        """Коэффициент ставки риска длинной позиции по клиенту. 2 – клиент со стандартным уровнем риска (КСУР); 1 – клиент с повышенным уровнем риска (КПУР)."""
...
class Dividend(google.protobuf.message.Message):
    ...
    @property
    def dividend_net(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
    ...
    @property
    def close_price(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
        """Цена закрытия инструмента на момент `ex_dividend_date`."""

    @property
    def yield_value(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        """Величина доходности."""
    ...
    def __init__(
        self,
        *,
        dividend_net: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        ...
        regularity: builtins.str = ...,
        close_price: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        yield_value: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
...
class AssetsRequest(google.protobuf.message.Message):
    ...
    INSTRUMENT_TYPE_FIELD_NUMBER: builtins.int
    INSTRUMENT_STATUS_FIELD_NUMBER: builtins.int
    instrument_type: TinvestPy.TinvestPy.grpc.common_pb2.InstrumentType.ValueType
    instrument_status: TinvestPy.TinvestPy.grpc.common_pb2.InstrumentStatus.ValueType
    """Статус запрашиваемых инструментов. [Возможные значения](#instrumentstatus)."""
    def __init__(
        self,
        *,
        instrument_type: TinvestPy.TinvestPy.grpc.common_pb2.InstrumentType.ValueType | None = ...,
        instrument_status: TinvestPy.TinvestPy.grpc.common_pb2.InstrumentStatus.ValueType | None = ...,
    ) -> None: ...
...
class AssetShare(google.protobuf.message.Message):
    ...
    @property
    def issue_size(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        """Объем выпуска (шт.)."""
    ...
    @property
    def dividend_rate(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
    ...
    @property
    def issue_size_plan(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        """Объявленное количество, шт."""

    @property
    def total_float(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
    ...
    def __init__(
        ...
        *,
        type: global___ShareType.ValueType = ...,
        issue_size: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        nominal: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        nominal_currency: builtins.str = ...,
        primary_index: builtins.str = ...,
        dividend_rate: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        preferred_share_type: builtins.str = ...,
        ipo_date: google.protobuf.timestamp_pb2.Timestamp | None = ...,
        ...
        placement_date: google.protobuf.timestamp_pb2.Timestamp | None = ...,
        repres_isin: builtins.str = ...,
        issue_size_plan: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        total_float: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
    ) -> None: ...
...
class AssetBond(google.protobuf.message.Message):
    ...
    @property
    def current_nominal(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        """Текущий номинал."""
    ...
    @property
    def placement_price(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
    ...
    def __init__(
        self,
        *,
        current_nominal: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        borrow_name: builtins.str = ...,
        issue_size: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        nominal: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        nominal_currency: builtins.str = ...,
        ...
        state_reg_date: google.protobuf.timestamp_pb2.Timestamp | None = ...,
        placement_date: google.protobuf.timestamp_pb2.Timestamp | None = ...,
        placement_price: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        issue_size_plan: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
    ) -> None: ...
...
class AssetEtf(google.protobuf.message.Message):
    ...
    """Валюта номинала."""
    @property
    def total_expense(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        """Суммарные расходы фонда в процентах."""

    @property
    def hurdle_rate(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        """Барьерная ставка доходности, после которой фонд имеет право на perfomance fee — в процентах."""

    @property
    def performance_fee(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
    ...
    @property
    def buy_premium(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        """Премия (надбавка к цене) при покупке доли в фонде — в процентах."""

    @property
    def sell_discount(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        """Ставка дисконта (вычет из цены) при продаже доли в фонде — в процентах."""

    @property
    def num_share(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
    ...
    @property
    def index_recovery_period(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        """Срок восстановления индекса после просадки."""

    @property
    def expense_commission(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        """Комиссия на покрытие расходов фонда в процентах."""

    @property
    def primary_index_tracking_error(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
    ...
    def __init__(
        self,
        *,
        total_expense: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        hurdle_rate: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        performance_fee: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        fixed_commission: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        payment_type: builtins.str = ...,
        watermark_flag: builtins.bool = ...,
        buy_premium: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        sell_discount: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        rebalancing_flag: builtins.bool = ...,
        rebalancing_freq: builtins.str = ...,
        management_type: builtins.str = ...,
        primary_index: builtins.str = ...,
        focus_type: builtins.str = ...,
        leveraged_flag: builtins.bool = ...,
        num_share: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        ucits_flag: builtins.bool = ...,
        released_date: google.protobuf.timestamp_pb2.Timestamp | None = ...,
        description: builtins.str = ...,
        primary_index_description: builtins.str = ...,
        primary_index_company: builtins.str = ...,
        index_recovery_period: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        inav_code: builtins.str = ...,
        div_yield_flag: builtins.bool = ...,
        expense_commission: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        primary_index_tracking_error: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        rebalancing_plan: builtins.str = ...,
        tax_rate: builtins.str = ...,
...
class FindInstrumentRequest(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        query: builtins.str = ...,
        instrument_kind: TinvestPy.TinvestPy.grpc.common_pb2.InstrumentType.ValueType | None = ...,
...
class GetBrandsRequest(google.protobuf.message.Message):
    ...
    @property
    def paging(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Page:
        """Настройки пагинации."""

    def __init__(
        self,
        *,
        paging: TinvestPy.TinvestPy.grpc.common_pb2.Page | None = ...,
    ) -> None: ...
...
class GetBrandsResponse(google.protobuf.message.Message):
    ...
    @property
    def paging(self) -> TinvestPy.TinvestPy.grpc.common_pb2.PageResponse:
        """Данные по пагинации."""
    ...
    def __init__(
        ...
        *,
        ...
        paging: TinvestPy.TinvestPy.grpc.common_pb2.PageResponse | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["paging", b"paging"]) -> builtins.bool: ...
...
class GetConsensusForecastsResponse(google.protobuf.message.Message):
    ...
    class ConsensusForecastsItem(google.protobuf.message.Message):
        ...
        @property
        def best_target_price(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
            """Целевая цена на 12 месяцев."""

        @property
        def best_target_low(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
            """Минимальная прогнозная цена."""

        @property
        def best_target_high(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        ...
        def __init__(
            ...
            *,
            ...
            asset_uid: builtins.str = ...,
            created_at: google.protobuf.timestamp_pb2.Timestamp | None = ...,
            best_target_price: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
            best_target_low: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
            best_target_high: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
            total_buy_recommend: builtins.int = ...,
            total_hold_recommend: builtins.int = ...,
            total_sell_recommend: builtins.int = ...,
            currency: builtins.str = ...,
    ...
    @property
    def page(self) -> TinvestPy.TinvestPy.grpc.common_pb2.PageResponse:
        """Данные по пагинации."""
    ...
    def __init__(
        ...
        *,
        ...
        page: TinvestPy.TinvestPy.grpc.common_pb2.PageResponse | None = ...,
    ) -> None: ...
...
class GetForecastResponse(google.protobuf.message.Message):
    ...
    class TargetItem(google.protobuf.message.Message):
        ...
        @property
        def current_price(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
            """Текущая цена."""

        @property
        def target_price(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
            """Прогнозируемая цена."""

        @property
        def price_change(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
            """Изменение цены."""

        @property
        def price_change_rel(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        ...
        def __init__(
            ...
            *,
            ...
            currency: builtins.str = ...,
            current_price: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
            target_price: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
            price_change: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
            price_change_rel: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
            show_name: builtins.str = ...,
        ) -> None: ...
    ...
    class ConsensusItem(google.protobuf.message.Message):
        ...
        @property
        def consensus(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
            """Прогнозируемая цена."""

        @property
        def min_target(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
            """Минимальная цена прогноза."""

        @property
        def max_target(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        ...
        def __init__(
            ...
            *,
            ...
            currency: builtins.str = ...,
            current_price: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
            consensus: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
            min_target: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
            max_target: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
            price_change: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
            price_change_rel: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        ) -> None: ...
...
class GetInsiderDealsResponse(google.protobuf.message.Message):
    ...
    class InsiderDeal(google.protobuf.message.Message):
        ...
        @property
        def price(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
            """Цена."""
        ...
        def __init__(
            ...
            *,
            ...
            date: google.protobuf.timestamp_pb2.Timestamp | None = ...,
            quantity: builtins.int = ...,
            price: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
            instrument_uid: builtins.str = ...,
            ticker: builtins.str = ...,
            investor_name: builtins.str = ...,
            investor_position: builtins.str = ...,
