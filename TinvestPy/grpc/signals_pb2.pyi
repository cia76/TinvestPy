...
class Strategy(google.protobuf.message.Message):
    ...
    @property
    def average_signal_yield(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        """Средняя доходность сигнала в стратегии."""

    @property
    def average_signal_yield_year(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        """Средняя доходность сигналов в стратегии за последний год."""

    @property
    def yield_year(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
    ...
    def __init__(
        ...
        *,
        ...
        total_signals: builtins.int = ...,
        time_in_position: builtins.int = ...,
        average_signal_yield: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        average_signal_yield_year: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        yield_year: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
    ) -> None: ...
...
class Signal(google.protobuf.message.Message):
    ...
    @property
    def stoploss(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
    ...
    def __init__(
        ...
        *,
        ...
        stoploss: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
