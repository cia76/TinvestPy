...
class MarketDataRequest(google.protobuf.message.Message):
    ...
    @property
    def ping(self) -> TinvestPy.TinvestPy.grpc.common_pb2.PingRequest:
    ...
    def __init__(
        ...
        *,
        ...
        ping: TinvestPy.TinvestPy.grpc.common_pb2.PingRequest | None = ...,
...
class Candle(google.protobuf.message.Message):
    ...
    """Источник свечей."""
    @property
    def open(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
    ...
    @property
    def high(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
    ...
    @property
    def low(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
    ...
    @property
    def close(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
    ...
    def __init__(
        ...
        *,
        figi: builtins.str = ...,
        interval: global___SubscriptionInterval.ValueType = ...,
        open: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        high: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        low: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        close: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        volume: builtins.int = ...,
...
class OrderBook(google.protobuf.message.Message):
    ...
    @property
    def limit_up(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
    ...
    @property
    def limit_down(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
    ...
    def __init__(
        ...
        *,
        ...
        time: google.protobuf.timestamp_pb2.Timestamp | None = ...,
        limit_up: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        limit_down: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        instrument_uid: builtins.str = ...,
        order_book_type: global___OrderBookType.ValueType = ...,
    ) -> None: ...
...
class GetOrderBookResponse(google.protobuf.message.Message):
    ...
    @property
    def last_price(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        """Цена последней сделки за 1 инструмент. Чтобы получить стоимость лота, нужно умножить на лотность инструмента. [Подробнее про перевод цен в валюту](./faq_marketdata/#_15)."""

    @property
    def close_price(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        """Цена закрытия за 1 инструмент. Чтобы получить стоимость лота, нужно умножить на лотность инструмента. [Подробнее про перевод цен в валюту](./faq_marketdata/#_15)."""
    ...
    def __init__(
        ...
        *,
        ...
        bids: collections.abc.Iterable[global___Order] | None = ...,
        asks: collections.abc.Iterable[global___Order] | None = ...,
        last_price: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        close_price: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        limit_up: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        limit_down: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
...
class InstrumentClosePriceResponse(google.protobuf.message.Message):
    ...
    @property
    def evening_session_price(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
    ...
    def __init__(
        ...
        *,
        ...
        instrument_uid: builtins.str = ...,
        price: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        evening_session_price: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        time: google.protobuf.timestamp_pb2.Timestamp | None = ...,
...
class GetTechAnalysisRequest(google.protobuf.message.Message):
    ...
    class Deviation(google.protobuf.message.Message):
        ...
        @property
        def deviation_multiplier(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
            """Количество стандартных отклонений, на которые отступают верхняя и нижняя границы."""

        def __init__(
            self,
            *,
            deviation_multiplier: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        ) -> None: ...
...
class GetTechAnalysisResponse(google.protobuf.message.Message):
    ...
    class TechAnalysisItem(google.protobuf.message.Message):
        ...
        @property
        def middle_band(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
            """Значение простого скользящего среднего (средней линии)."""

        @property
        def upper_band(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
            """Значение верхней линии Боллинджера."""

        @property
        def lower_band(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
            """Значение нижней линии Боллинджера."""

        @property
        def signal(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
            """Значение сигнальной линии."""

        @property
        def macd(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
            """Значение линии MACD."""
        ...
        def __init__(
            ...
            *,
            ...
            middle_band: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
            upper_band: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
            lower_band: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
            signal: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
            macd: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        ) -> None: ...
