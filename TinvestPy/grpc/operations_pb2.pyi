...
class Operation(google.protobuf.message.Message):
    ...
    @property
    def payment(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
        """Сумма операции."""

    @property
    def price(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
    ...
    def __init__(
        ...
        *,
        ...
        parent_operation_id: builtins.str = ...,
        currency: builtins.str = ...,
        payment: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        price: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        state: global___OperationState.ValueType = ...,
        quantity: builtins.int = ...,
        quantity_rest: builtins.int = ...,
        figi: builtins.str = ...,
...
class PortfolioResponse(google.protobuf.message.Message):
    ...
    """Идентификатор счета пользователя."""
    @property
    def total_amount_shares(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
        """Общая стоимость акций в портфеле."""

    @property
    def total_amount_bonds(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
        """Общая стоимость облигаций в портфеле."""

    @property
    def total_amount_etf(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
        """Общая стоимость фондов в портфеле."""

    @property
    def total_amount_currencies(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
        """Общая стоимость валют в портфеле."""

    @property
    def total_amount_futures(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
        """Общая стоимость фьючерсов в портфеле."""

    @property
    def expected_yield(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
    ...
    @property
    def total_amount_options(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
        """Общая стоимость опционов в портфеле."""

    @property
    def total_amount_sp(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
        """Общая стоимость структурных нот в портфеле."""

    @property
    def total_amount_portfolio(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
    ...
    @property
    def daily_yield(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
        """Рассчитанная доходность портфеля за день в рублях."""

    @property
    def daily_yield_relative(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        """Относительная доходность в день в %."""

    def __init__(
        self,
        *,
        total_amount_shares: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        total_amount_bonds: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        total_amount_etf: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        total_amount_currencies: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        total_amount_futures: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        expected_yield: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        positions: collections.abc.Iterable[global___PortfolioPosition] | None = ...,
        account_id: builtins.str = ...,
        total_amount_options: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        total_amount_sp: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        total_amount_portfolio: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        virtual_positions: collections.abc.Iterable[global___VirtualPortfolioPosition] | None = ...,
        daily_yield: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        daily_yield_relative: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
    ) -> None: ...
...
class PositionsResponse(google.protobuf.message.Message):
    ...
    @property
    def money(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue]:
        """Массив валютных позиций портфеля."""

    @property
    def blocked(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue]:
    ...
    def __init__(
        self,
        *,
        money: collections.abc.Iterable[TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue] | None = ...,
        blocked: collections.abc.Iterable[TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue] | None = ...,
...
class WithdrawLimitsResponse(google.protobuf.message.Message):
    ...
    @property
    def blocked_guarantee(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue]:
    ...
    def __init__(
        ...
        *,
        money: collections.abc.Iterable[TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue] | None = ...,
        blocked: collections.abc.Iterable[TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue] | None = ...,
        blocked_guarantee: collections.abc.Iterable[TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue] | None = ...,
    ) -> None: ...
...
class PortfolioPosition(google.protobuf.message.Message):
    ...
    """Тикер инструмента."""
    @property
    def quantity(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        """Количество инструмента в портфеле в штуках."""

    @property
    def average_position_price(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
    ...
    @property
    def current_nkd(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
        """Текущий НКД."""

    @property
    def average_position_price_pt(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        """Deprecated Средняя цена позиции в пунктах (для фьючерсов). Для пересчета возможна задержка до одной секунды."""

    @property
    def current_price(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
        """Текущая цена за 1 инструмент. Чтобы получить стоимость лота, нужно умножить на лотность инструмента."""

    @property
    def average_position_price_fifo(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
        """Средняя цена позиции по методу FIFO. Для пересчета возможна задержка до одной секунды."""

    @property
    def quantity_lots(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        """Deprecated Количество лотов в портфеле."""

    @property
    def blocked_lots(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        """Количество бумаг, заблокированных выставленными заявками."""

    @property
    def var_margin(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
        """Вариационная маржа."""

    @property
    def expected_yield_fifo(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        """Текущая рассчитанная доходность позиции."""
    ...
    def __init__(
        ...
        *,
        figi: builtins.str = ...,
        instrument_type: builtins.str = ...,
        quantity: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        average_position_price: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        expected_yield: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        current_nkd: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        average_position_price_pt: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        current_price: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        average_position_price_fifo: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        quantity_lots: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        blocked: builtins.bool = ...,
        blocked_lots: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        position_uid: builtins.str = ...,
        instrument_uid: builtins.str = ...,
        var_margin: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        expected_yield_fifo: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        daily_yield: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        ticker: builtins.str = ...,
    ) -> None: ...
...
class BrokerReport(google.protobuf.message.Message):
    ...
    @property
    def order_amount(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
        """Сумма без НКД."""

    @property
    def aci_value(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        """НКД."""

    @property
    def total_order_amount(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
        """Сумма сделки."""

    @property
    def broker_commission(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
        """Комиссия брокера."""

    @property
    def exchange_commission(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
        """Комиссия биржи."""

    @property
    def exchange_clearing_commission(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
        """Комиссия клирингового центра."""

    @property
    def repo_rate(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        """Ставка РЕПО, %."""
    ...
    def __init__(
        ...
        *,
        ...
        price: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        quantity: builtins.int = ...,
        order_amount: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        aci_value: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        total_order_amount: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        broker_commission: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        exchange_commission: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        exchange_clearing_commission: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        repo_rate: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        party: builtins.str = ...,
...
class DividendsForeignIssuerReport(google.protobuf.message.Message):
    ...
    @property
    def dividend(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        """Выплаты на одну бумагу"""

    @property
    def external_commission(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        """Комиссия внешних платежных агентов."""

    @property
    def dividend_gross(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        """Сумма до удержания налога."""

    @property
    def tax(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        """Сумма налога, удержанного агентом."""

    @property
    def dividend_amount(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
    ...
    def __init__(
        ...
        *,
        ...
        issuer_country: builtins.str = ...,
        quantity: builtins.int = ...,
        dividend: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        external_commission: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        dividend_gross: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        tax: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        dividend_amount: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        currency: builtins.str = ...,
    ) -> None: ...
...
class PortfolioStreamRequest(google.protobuf.message.Message):
    ...
    @property
    def ping_settings(self) -> TinvestPy.TinvestPy.grpc.common_pb2.PingDelaySettings:
    ...
    def __init__(
        ...
        *,
        ...
        ping_settings: TinvestPy.TinvestPy.grpc.common_pb2.PingDelaySettings | None = ...,
    ) -> None: ...
...
class PortfolioStreamResponse(google.protobuf.message.Message):
    ...
    @property
    def ping(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Ping:
    ...
    def __init__(
        ...
        *,
        ...
        ping: TinvestPy.TinvestPy.grpc.common_pb2.Ping | None = ...,
    ) -> None: ...
...
class OperationItem(google.protobuf.message.Message):
    ...
    @property
    def commission(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
        """Комиссия."""

    @property
    def yield_relative(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        """Относительная доходность."""

    @property
    def accrued_int(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
    ...
    def __init__(
        ...
        *,
        ...
        payment: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        price: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        commission: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        yield_relative: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        accrued_int: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        quantity: builtins.int = ...,
        quantity_rest: builtins.int = ...,
        quantity_done: builtins.int = ...,
...
class PositionsMoney(google.protobuf.message.Message):
    ...
    @property
    def available_value(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
        """Доступное количество валютный позиций."""

    @property
    def blocked_value(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
        """Заблокированное количество валютных позиций."""

    def __init__(
        self,
        *,
        available_value: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        blocked_value: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
    ) -> None: ...
