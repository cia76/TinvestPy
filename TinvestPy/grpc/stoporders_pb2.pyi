...
class PostStopOrderRequest(google.protobuf.message.Message):
    ...
    class TrailingData(google.protobuf.message.Message):
        ...
        @property
        def indent(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
            """Отступ."""

        @property
        def spread(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
            """Размер защитного спреда."""

        def __init__(
            self,
            *,
            indent: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
            indent_type: global___TrailingValueType.ValueType = ...,
            spread: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
            spread_type: global___TrailingValueType.ValueType = ...,
        ) -> None: ...
    ...
    @property
    def stop_price(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
    ...
    def __init__(
        ...
        *,
        ...
        stop_price: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        direction: global___StopOrderDirection.ValueType = ...,
        account_id: builtins.str = ...,
        expiration_type: global___StopOrderExpirationType.ValueType = ...,
        stop_order_type: global___StopOrderType.ValueType = ...,
...
class StopOrder(google.protobuf.message.Message):
    ...
    class TrailingData(google.protobuf.message.Message):
        ...
        @property
        def extr(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
            """Локальный экстремум."""
        ...
        def __init__(
            ...
            *,
            ...
            status: global___TrailingStopStatus.ValueType = ...,
            price: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
            extr: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        ) -> None: ...
    ...
    @property
    def stop_price(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
    ...
    def __init__(
        ...
        *,
        ...
        stop_price: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        instrument_uid: builtins.str = ...,
        take_profit_type: global___TakeProfitType.ValueType = ...,
