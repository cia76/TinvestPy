...
class GetMarginAttributesResponse(google.protobuf.message.Message):
    ...
    @property
    def liquid_portfolio(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
    ...
    @property
    def starting_margin(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
    ...
    @property
    def minimal_margin(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
    ...
    @property
    def funds_sufficiency_level(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        """Уровень достаточности средств. Соотношение стоимости ликвидного портфеля к начальной марже."""

    @property
    def amount_of_missing_funds(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
        """Объем недостающих средств. Разница между стартовой маржой и ликвидной стоимости портфеля."""

    @property
    def corrected_margin(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
    ...
    def __init__(
        self,
        *,
        liquid_portfolio: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        starting_margin: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        minimal_margin: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        funds_sufficiency_level: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        amount_of_missing_funds: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        corrected_margin: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
    ) -> None: ...
