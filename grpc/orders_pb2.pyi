...
class PostOrderRequest(google.protobuf.message.Message):
    ...
    price_type: TinvestPy.TinvestPy.grpc.common_pb2.PriceType.ValueType
    """Тип цены."""
...
class PostOrderResponse(google.protobuf.message.Message):
    ...
    @property
    def initial_order_price(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
        """Начальная цена заявки. Произведение количества запрошенных лотов на цену."""

    @property
    def executed_order_price(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
    ...
    @property
    def initial_commission(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
        """Начальная комиссия. Комиссия рассчитанная при выставлении заявки."""

    @property
    def executed_commission(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
    ...
    @property
    def initial_security_price(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
        """Начальная цена за 1 инструмент. Для получения стоимости лота требуется умножить на лотность инструмента."""

    @property
    def initial_order_price_pt(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        """Начальная цена заявки в пунктах (для фьючерсов)."""

    @property
    def response_metadata(self) -> TinvestPy.TinvestPy.grpc.common_pb2.ResponseMetadata:
        """Метадата"""
    ...
    def __init__(
        ...
        *,
        ...
        lots_requested: builtins.int = ...,
        lots_executed: builtins.int = ...,
        initial_order_price: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        executed_order_price: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        total_order_amount: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        initial_commission: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        executed_commission: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        aci_value: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        figi: builtins.str = ...,
        direction: global___OrderDirection.ValueType = ...,
        initial_security_price: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        order_type: global___OrderType.ValueType = ...,
        message: builtins.str = ...,
        initial_order_price_pt: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        instrument_uid: builtins.str = ...,
        order_request_id: builtins.str = ...,
        response_metadata: TinvestPy.TinvestPy.grpc.common_pb2.ResponseMetadata | None = ...,
    ) -> None: ...
...
class PostOrderAsyncRequest(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        price_type: TinvestPy.TinvestPy.grpc.common_pb2.PriceType.ValueType | None = ...,
        confirm_margin_trade: builtins.bool = ...,
    ) -> None: ...
...
class OrderState(google.protobuf.message.Message):
    ...
    @property
    def service_commission(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
        """Сервисная комиссия."""
    ...
    def __init__(
        ...
        *,
        ...
        service_commission: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        currency: builtins.str = ...,
        order_type: global___OrderType.ValueType = ...,
...
class GetMaxLotsResponse(google.protobuf.message.Message):
    ...
    class BuyLimitsView(google.protobuf.message.Message):
        ...
        @property
        def buy_money_amount(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
            """Количество доступной валюты для покупки"""

        def __init__(
            self,
            *,
            buy_money_amount: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
            buy_max_lots: builtins.int = ...,
            buy_max_market_lots: builtins.int = ...,
        ) -> None: ...
...
class GetOrderPriceResponse(google.protobuf.message.Message):
    ...
    class ExtraBond(google.protobuf.message.Message):
        ...
        @property
        def nominal_conversion_rate(self) -> TinvestPy.TinvestPy.grpc.common_pb2.Quotation:
        ...
        def __init__(
            ...
            *,
            aci_value: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
            nominal_conversion_rate: TinvestPy.TinvestPy.grpc.common_pb2.Quotation | None = ...,
        ) -> None: ...
    ...
    class ExtraFuture(google.protobuf.message.Message):
        ...
        @property
        def initial_margin(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
            """Гарантийное обеспечение для фьючерса"""

        def __init__(
            self,
            *,
            initial_margin: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        ) -> None: ...
    ...
    @property
    def initial_order_amount(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
    ...
    @property
    def executed_commission_rub(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
    ...
    @property
    def deal_commission(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
    ...
    def __init__(
        ...
        *,
        total_order_amount: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        initial_order_amount: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        lots_requested: builtins.int = ...,
        executed_commission: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        executed_commission_rub: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        service_commission: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
        deal_commission: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
...
class SubscriptionResponse(google.protobuf.message.Message):
    ...
    status: TinvestPy.TinvestPy.grpc.common_pb2.ResultSubscriptionStatus.ValueType
    """Статус подписки."""
    ...
    @property
    def error(self) -> TinvestPy.TinvestPy.grpc.common_pb2.ErrorDetail: ...
    def __init__(
        self,
        *,
        tracking_id: builtins.str = ...,
        ...
        stream_id: builtins.str = ...,
        accounts: collections.abc.Iterable[builtins.str] | None = ...,
        error: TinvestPy.TinvestPy.grpc.common_pb2.ErrorDetail | None = ...,
    ) -> None: ...
...
class OrderStateStreamResponse(google.protobuf.message.Message):
    ...
    class OrderState(google.protobuf.message.Message):
        ...
        @property
        def order_price(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
            """Цена выставления заявки."""

        @property
        def amount(self) -> TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue:
        ...
        def __init__(
            ...
            *,
            ...
            account_id: builtins.str = ...,
            initial_order_price: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
            order_price: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
            amount: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
            executed_order_price: TinvestPy.TinvestPy.grpc.common_pb2.MoneyValue | None = ...,
            currency: builtins.str = ...,
            lots_requested: builtins.int = ...,
            lots_executed: builtins.int = ...,
